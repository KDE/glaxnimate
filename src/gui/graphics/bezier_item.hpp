...
class PointItem : public QGraphicsObject
{
    Q_OBJECT
public:
    PointItem(int index, const math::bezier::Point& point, QGraphicsItem* parent, model::AnimatedPropertyBase* property);
...
public:
    ...
    model::AnimatedPropertyBase* target_property() const;
