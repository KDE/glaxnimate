...
std::unique_ptr<glaxnimate::settings::SettingsGroup> glaxnimate::io::video::VideoFormat::save_settings(model::Composition* comp) const
{
    return std::make_unique<glaxnimate::settings::SettingsGroup>(glaxnimate::settings::SettingList{
        ...
        glaxnimate::settings::Setting{"background",    i18n("Background"), i18n("Background color"),                           QColor(0, 0, 0, 0)},
        glaxnimate::settings::Setting{"width",         i18n("Width"),      i18n("If not 0, it will overwrite the size"),       int(comp->width.get()),  0, 99999},
        glaxnimate::settings::Setting{"height",        i18n("Height"),     i18n("If not 0, it will overwrite the size"),       int(comp->height.get()), 0, 99999},
